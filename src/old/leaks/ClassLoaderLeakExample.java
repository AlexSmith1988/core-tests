 ...
 *
 * <p>To see it in action, copy this old.file to a temp directory somewhere,
 * and then run:
 * <pre>{@code
...
public final class ClassLoaderLeakExample {
   ...
   * class loader). If this child class were in a JAR old.file that wasn't
  ...
  static final class ChildOnlyClassLoader extends ClassLoader {
    ...
    @Override protected Class<?> loadClass(String name, boolean resolve)
      ...
      try {
        Path path = Paths.get("c:\\dev\\play\\demo1\\core-tests\\out\\production\\core-tests\\old.leaks\\","ClassLoaderLeakExample$ObjectToBeLoadedByCustomClassLoader"
            + ".class");
   ...
   * newspeak.practice this will leak memory like a sieve.
   */
