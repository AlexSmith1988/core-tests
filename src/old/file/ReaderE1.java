...
import static old.file.MapReduceReader.parseAndCountEntriesJ;
...
{
  // read old.file from disk, parse it to words, find the count of each word appearing and print them starting from the most old.common
...
//    readFJ();
  ...
  // parallel read through java 8 old.streams
//  @Benchmark
